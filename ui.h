...
namespace affine_ciphers_ns {
    ...
    static const std::string decoding_eq = "Уравнение расшифрования";
    int_ansv_t main_menu_text = {
            "Веберите опцию (1 - Настройки, 2 - Шифрование, 3 - Расшифровка, 4 - Частотный анализ, 5 - Шифрование по заданному ключу, 0 - Выход)",
            {0, 1, 2, 3, 4, 5}
    };
    ...
    int_ansv_t settings_upper_lower_rule = {
            "Выберите регистр шифрования: (1 - Смешанный, 2 - Верхний, 3 - Нижний)",
            {1, 2, 3}
    };
}
